...
//                             {/* FIXED: Resolution Time Field - Non-editable */}
...
//                               </span>
//                               <span className="resolution-time-note">
...
//                         Resolution: <strong className={file.resolution_badge_class}>
//                           {file.resolution_time}
//                         </strong>
//                       </li>
//                     ))}
...
function AnalysePage() {
  ...
  const handleFailedOkClick = () => {
    ...
    // Navigate back to complaint page or home page
    navigate("/complaint");
  };
